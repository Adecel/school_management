...
//    @ManyToOne
//    @JoinColumn(name = "city_id", updatable = false, insertable = false) //I have add this
//    // dont remote we gona use it the controller
//    private City city;
//
//
//    public Address() {
//    }
//
//    public Address(String unitNumber, String complexName,
...
//
//    public static class AddressBYID{
//        private String streetNumber;
//        private String streetName;
//        private String  postalCode;
//        private City city;
//
//        public AddressBYID(String streetNumber, String streetName, String  postalCode, City city) {
//            this.streetNumber = streetNumber;
//            this.streetName = streetName;
//            this.postalCode = postalCode;
//            this.city = city;
...
//            AddressBYID addressID = (AddressBYID) o;
//            return postalCode == addressID.postalCode &&
//                    streetNumber.equals(addressID.streetNumber)
//                    && streetName.equals(addressID.streetName)
